package br.inter.desafio.domain.entities.criptografia;
...
public class Criptografia {
	...
	private static final Map<Integer, KeyPair> keys = new HashMap<>();
	private static final Decoder DECODER = Base64.getDecoder();
	private static final Encoder ENCODER = Base64.getEncoder();

	public static void gerarChaves(Integer idUsuario) throws GeneralSecurityException {
		try {
